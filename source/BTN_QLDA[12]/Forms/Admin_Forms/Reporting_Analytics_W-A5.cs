...
namespace BTN_QLDA_12_.Forms
{
    public partial class Reporting_Analytics_W_A5 : Form
    {
        ...
        private void LoadProjectRatioChart()
        {
            ...
            decimal Excellent = ExcellentRatio / total * 100;
            decimal Good = GoodRatio / total * 100;
            decimal Fail = FailedRatio / total * 100;
        ...
        private void tmSideBar_Tick(object sender, EventArgs e)
        {
            if (menuExpand)
            {
                ...
                pictureBox12.Location = new Point(X, pictureBox12.Location.Y);
